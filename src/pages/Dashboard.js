  ...
  return (
    <>
        ...
        <div id="lock-screen" title="Screen Locked">
            <a href="login.html" className="header right button grey flat">Logout</a>
        ...
        <div id="settings" className="settings-content" data-width={450}>
            ...
            <li><a href="#settings-1"><img src="img/icons/packs/fugue/24x24/user-business.png" /><span>Account Settings</span></a></li>
            <li><a href="#settings-2"><img src="img/icons/packs/fugue/24x24/balloon.png" /><span>Notifications</span></a></li>
            <li><a href="#settings-3"><img src="img/icons/packs/fugue/24x24/credit-card.png" /><span>Invoicing</span></a></li>
            </ul>
        ...
        <section id="toolbar">
            ...
            <div className="right">
                ...
                <li>
                    ...
                    <h3>New Messages</h3>
                    {/* Button bar */}
                    <a className="button flat left grey">Close</a>
                    ...
                    <div className="content mail">
                        ...
                        <li>
                            ...
                            <div className="actions">
                                ...
                                <a  className="red right" href="#">Delete</a>
                            </div>
                            </div>
                        </li>
                        <li>
        ...
        <div role="main" id="main" className="container_12 clearfix">
            ...
            <ul className="shortcuts">
                ...
                <div className="small">
                    <h3>Create a User</h3>
                    {/* Button bar */}
                    <button className="button flat left grey" >Close</button>
                    <button className="button flat right" >Create</button>
                    <div className="content">
                ...
                <div className="small">
                    ...
                    {/* Button bar */}
                    <button className="button flat left grey" >Close</button>
                    <button className="button flat right" >Send</button>
                    <div className="content">
                    <form className="full grid">
                        <div className="row no-bg">
                        <p className="_100 small">
            ...
            <div className="top">
                ...
                <nav><ul className="collapsible accordion">
                    <li className="current"><a href="dashboard.html"><img src="img/icons/packs/fugue/16x16/dashboard.png" height={16} width={16} />Dashboard</a></li>
                    <li>
                    <a href="#"><img src="img/icons/packs/fugue/16x16/ui-layered-pane.png" height={16} width={16} />UI Widgets<span className="badge">4</span></a>
                    <ul>
                    ...
                    <li>
                    <a href="#"><img src="img/icons/packs/fugue/16x16/application-form.png" height={16} width={16} />Form Elements</a>
                    <ul>
                    ...
                    <li>
                    <a href="#"><img src="img/icons/packs/fugue/16x16/chart.png" height={16} width={16} />Statistics / Charts<span className="badge">2</span></a>
                    <ul>
                    ...
                    <li>
                    <a href="#"><img src="img/icons/packs/fugue/16x16/table.png" height={16} width={16} />Tables</a>
                    <ul>
                    ...
                    <li>
                    <a href="#"><img src="img/icons/packs/fugue/16x16/document-horizontal.png" height={16} width={16} />Other Pages</a>
                    <ul>
